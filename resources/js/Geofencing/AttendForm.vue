<template>
  ...
  <li class="bg-white shadow-lg p-4 rounded-lg flex justify-between w-full mb-3">
    ...
    <div class="flex flex-wrap m-3 items-center">
        ...
        <div v-else v-for="(attend,index) in attends" v-bind:key="index" class="m-1">
            <badge-red v-if="attend.desc_value=='결석'" @click="openAttendDialog(index)" >{{ attend.attend }}</badge-red>
            <badge-yellow v-else-if="attend.desc_value=='지각'" @click="openAttendDialog(index)" >{{ attend.attend }}</badge-yellow>  
    ...
    <Dialog :show="dialogShow" @close="closeDialog">
        ...
        <template #footer>
            ...
            <jet-button type="button" class="ml-2">
                <inertia-link :href="route('attend')" class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">확인</inertia-link>
            </jet-button>
        ...
        <template #footer>
            ...
            <jet-button type="button" class="ml-2 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" @click="closeDialog">
                닫기
            </jet-button>
